      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex-1 px-4 py-4 lg:px-6">
            ...
            {activeTab === 'weekly' && <div className="flex items-center justify-center py-16"><p style={{ color: t.muted }}>Weekly reflection temporarily disabled for debugging - testing deployment</p></div>}
